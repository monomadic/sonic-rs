	...
	public class App
	{
		...
		{	
			Console.WriteLine("Using arg1 {0:} arg2 {0:} VSize {0:}", Arg1, Arg2, VSize);
			GenerateKey(out encryptionStringA, Arg1);
			Console.Write("encryptionStringA 0x");
			...
			Console.WriteLine("encryptionStringB ", this.encryptionStringB);
